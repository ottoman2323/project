...
const passwordElement = document.querySelectorAll('.passwordElement')
const passwordChangeButton = document.querySelectorAll('.passwordChangeButton')
...
passwordChangeButton.forEach((element) => {
   element.addEventListener('click', () => {
      passwordElement.forEach((pswElement)=>{
         if(pswElement.type === 'password'){
            pswElement.type = 'text';
